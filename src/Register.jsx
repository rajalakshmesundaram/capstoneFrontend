...
export const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('https://capstonebackend-7.onrender.com/api/createUser', formData)
 ...
 <select className="form-select" id="inputGroupSelect01" name="role" value={formData.role} onChange={handleChange}required>
